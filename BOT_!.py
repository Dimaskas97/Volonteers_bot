...
def bot_message(message):
    if message.chat.type == 'private':
            if message.text == 'Регистрация нового волонтёра':
                ...
                bot.send_message(message.chat.id, 'Информация о коротких проектах, которые есть на данный момент,'
                ...
                bot.send_message(message.chat.id, 'Информация о долгих проектах, которые есть на данный момент,'
